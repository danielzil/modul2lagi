...
class StoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/stories')->with('success', 'Story has been saved!');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('/stories')->with('success', 'Story has been updated');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect('/stories')->with('success', 'Story has been deleted');
    }
}
